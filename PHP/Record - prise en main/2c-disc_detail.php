...
<?php include('header.php'); ?>
    ...
    <a href="2b-disc.php" class="btn bg-black text-white fw-bold my-4">Retour aux disques</a>
    <br>
    <br>
    ...
    <form action="2h-script_disc_delete.php" method="post" enctype="multipart/form-data">
        ...
        <a href="2f-modification_disc.php?id=<?= $myArtist->disc_id ?>" class="btn bg-black text-white fw-bold my-4">Modifier</a>
        <input type="submit" value="Supprimer" class="btn bg-black text-white fw-bold my-4">
