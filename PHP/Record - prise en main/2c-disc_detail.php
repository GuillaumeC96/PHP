...
<body class="p-5">
    ...
    <a href="2b-disc.php"><button>Retour à la liste des disques</button></a>

    <br>
    <br>

    <form action="2e-script_disc_ajout.php" method="post" enctype="multipart/form-data">
