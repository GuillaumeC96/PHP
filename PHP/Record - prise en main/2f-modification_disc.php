...
<?php include('header.php'); ?>
    ...
    <form action="2g-script_disc_modif.php?id=.$id" method="post" enctype="multipart/form-data">
        ...
        <a href="2c-disc_detail.php?id=<?= $myArtist->disc_id ?>" class="btn bg-black text-white fw-bold my-4">Retour</a>
